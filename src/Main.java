...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("-");
        System.out.println("Conteúdos Inscritos Camila: " + devMatheus.getConteudosInscritos());
        System.out.println("Conteúdos Concluidos Camila: " + devMatheus.getConteudosConcluidos());
        System.out.println("XP:" + devMatheus.voidcalcularXp());
        ...
        System.out.println("XP:" + devJoao.voidcalcularXp());
